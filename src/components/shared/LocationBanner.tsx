...
export function LocationBanner({ onDismiss }: LocationBannerProps) {
  return (
    <div className="fixed top-0 left-0 right-0 z-[300] bg-brand-accent text-bg px-4 py-3 flex items-center justify-between text-[13px] font-medium safe-area-top lg:left-[420px]">
