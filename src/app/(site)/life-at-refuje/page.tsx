  ...
  return (
    <>
      ...
      <section className="px-5 md:px-10 py-12 md:py-20 max-w-[1400px] mx-auto">
        ...
        <h3 className="font-[family-name:var(--font-biorhyme)] text-[24px] md:text-[36px] font-bold text-[#434431] tracking-[2px] text-center mb-6">
          Community Connections
        </h3>
        <p className="font-[family-name:var(--font-brinnan)] text-[14px] font-bold text-[#434431] tracking-[1px] text-center mb-4">
          By the locals, for the world
        </p>
        <p className="font-[family-name:var(--font-brinnan)] text-[15px] text-[#434431] leading-relaxed text-center max-w-[700px] mx-auto tracking-[0.5px]">
      ...
      {/* Pillars */}
      <section className="px-5 md:px-10 py-12 md:py-20 max-w-[1400px] mx-auto">
        <h2 className="font-[family-name:var(--font-biorhyme)] text-[20px] md:text-[24px] font-bold text-[#434431] tracking-[2px] uppercase text-center mb-10">
          Our Commitment
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((pillar) => (
            <div key={pillar.title} className="rounded-[15px] overflow-hidden bg-[#FFE9CF]">
              ...
              <div className="p-5">
                <h3 className="font-[family-name:var(--font-brinnan)] text-[15px] font-bold text-[#434431] tracking-[1px] mb-2">
                  {pillar.title}
                </h3>
                <p className="font-[family-name:var(--font-brinnan)] text-[13px] text-[#7C7B55] leading-relaxed tracking-[0.5px]">
                  {pillar.description}
                </p>
              </div>
            </div>
      ...
      <section className="bg-[#434431] px-5 md:px-10 py-12 md:py-20">
        <div className="max-w-[1400px] mx-auto text-center">
          <h2 className="font-[family-name:var(--font-brinnan)] text-[14px] font-bold text-[#FFE9CF] tracking-[2px] uppercase mb-3">
            Behind the Experiences
          </h2>
          <h3 className="font-[family-name:var(--font-biorhyme)] text-[24px] md:text-[30px] font-bold text-[#FFE9CF] mb-6">
            Crafting mindful adventures
          </h3>
          <p className="font-[family-name:var(--font-brinnan)] text-[15px] text-[#FFE9CF]/70 leading-relaxed max-w-[600px] mx-auto tracking-[0.5px]">
      ...
      <section className="px-5 md:px-10 py-12 md:py-20 max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1">
            ...
            <h3 className="font-[family-name:var(--font-biorhyme)] text-[24px] md:text-[30px] font-bold text-[#434431] mb-6">
              Treading lightly, Impacting Deeply
            </h3>
            <p className="font-[family-name:var(--font-brinnan)] text-[15px] text-[#7C7B55] leading-relaxed tracking-[0.5px]">
        ...
        <div className="relative h-[50vh] md:h-[60vh]">
          ...
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
            <div className="text-center px-5 max-w-[600px]">
              ...
              <h3 className="font-[family-name:var(--font-biorhyme)] text-[24px] md:text-[30px] font-bold text-white mb-4">
                Our Home
              </h3>
              <p className="font-[family-name:var(--font-brinnan)] text-[15px] text-white/80 leading-relaxed tracking-[0.5px]">
